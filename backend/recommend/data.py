...
round_face_recommendations: List[Dict[str, str]] = [
    ...
    {'name': "버즈 컷", 'desc': '반삭과도 같은 윗 기장감에 짧게 다듬은 옆,뒤로 형태를 완성합니다. 버즈컷은 모험심이 강하거나 그와 맞는 스타일을 갖춘 사람만이 소화해낼 수 있는 헤어컷입니다.', 'sex': 'male', 'path': './image/male_hairstyle/round/buzz_cut.jpg'},
...
oblong_face_recommendations: List[Dict[str, str]] = [
    ...
    {'name': "쉐도우 펌", 'desc': '헤어 컬러링 기술 중 하나로, 머리카락에 약간의 그림자를 입히는 것을 의미합니다. 머릿결이 더욱 풍부해 보이고 볼륨감이 느껴지는 효과를 낼 수 있습니다.', 'sex': 'male', 'path': './image/male_hairstyle/oblong/shadow_perm.jpg'},
